...
public class ProductServiceImpl implements ProductService{
	...
	@Override
	public Page<Product> findByNameContainingOrDescriptionContaining(String name, String name1, Pageable pageable) {
		return productRepository.findByNameContainingOrDescriptionContaining(name, name1, pageable);
	}
